...
import com.ibps.demo.web.UserController;
...
privileged aspect UserController_Roo_Controller {
    ...
    public String UserController.show(@PathVariable("userid") Integer userid, Model uiModel) {
    ...
    public String UserController.updateForm(@PathVariable("userid") Integer userid, Model uiModel) {
        populateEditForm(uiModel, User.findUser(userid));
        return "users/update";
    }
    
    @RequestMapping(value = "/{userid}", method = RequestMethod.DELETE, produces = "text/html")
    public String UserController.delete(@PathVariable("userid") Integer userid, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
